...
void main() async {
  ...
  final buffer = StringBuffer()
    ...
    ..writeln('// Generated by: dart run assets/sounds/generator.dart\n')
    ..writeln("import 'package:respire/components/Global/SoundAsset.dart';\n")
    ..writeln('class ReSpireSounds {')
    ..writeln('  static final Map<String, SoundAsset> longSounds = {');
  ...
  buffer.writeln('  };\n');
  buffer.writeln('  static final Map<String, SoundAsset> shortSounds = {');
