...
Celem projektu jest stworzenie tworzenie intuicyjnej i funkcjonalnej aplikacji mobilnej, umożliwiającej użytkownikom skuteczny trening oddechowy, która ma pomagać w poprawie kontroli oddechu, redukcji stresu oraz zwiększeniu świadomości oddechowej. Aplikacja zostanie opublikowana w Google Play Store i Apple App Store, aby dotrzeć do jak najszerszego grona użytkowników w Polsce.

Zakres projektu obejmuje pełny cykl wytworzenia aplikacji mobilnej ReSpire, od fazy projektowania, poprzez implementację, aż po wdrożenie i publikację. 

W ramach prac zostanie zaprojektowany i zaimplementowany intuicyjny interfejs użytkownika, który umożliwi łatwe zarządzanie sesjami treningu oddechowego. Kluczowym aspektem aplikacji będzie szeroka personalizacja poprzez wybór parametrów takich jak typ fazy (wdech, wydech, przerwa), długość fazy, inkrementacja czy powtórzeń. Projekt zakłada również opracowanie mechanizmów interaktywnych, takich jak wizualizacje wspomagające kontrolę oddechu.
Zwieńczeniem projektu będzie publikacja aplikacji w sklepach Google Play Store i Apple App Store z interfejsem zarówno w języku polskim jak i angielskim, co umożliwi szeroką dostępność wśród użytkowników w Polsce, jak i za granicą.
