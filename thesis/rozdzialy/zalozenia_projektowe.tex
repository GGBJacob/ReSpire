...
\begin{itemize}
    ...
    \item \textbf{Wielopoziomowy System Audio}: Złożony mechanizm zarządzania dźwiękiem, pozwalający na przypisywanie tła akustycznego na trzech poziomach hierarchii: globalnym (cały trening), etapu oraz fazy (unikalne dźwięki dla wdechu, wydechu, wstrzymania, regeneracji). System obsługuje komunikaty głosowe zrealizowane za pomocą  i sygnały dźwiękowe informujące o zmianie fazy bez konieczności patrzenia na ekran.
